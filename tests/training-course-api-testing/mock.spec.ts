...
// Generamos nosotros todo el json de pruebas (antes de que la API esté desarrollada)
test("Hace un mock de una fruta que no viene de la API real ", async ({ page }) => {
    // Hacemos un mock de la API antes de navegar
    await page.route('*/**/api/v1/fruits', async route => {
        const json = [{ name: 'Melocotón', id: 26 }, {name: 'Manzana', id: 27}];
...
// Modificamos el cuerpo de la respuesta y añadimos información extra
